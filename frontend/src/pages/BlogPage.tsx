...
const BlogPage = () => {
  const posts = [
    { id: 1, title: "The Art of Skin Minimalism", category: "Skincare", img: "https://beautina-cosmetic.myshopify.com/cdn/shop/files/gallery-2-v2.webp?v=1773124923", date: "Oct 12, 2023", excerpt: "Discover the secrets to effortless beauty with our comprehensive guide to stripping back your routine." },
    { id: 2, title: "Discover Our Anti-Age Recovery Ritual", category: "Rituals", img: "https://beautina-cosmetic.myshopify.com/cdn/shop/files/home-before_1.jpg?v=1773290460", date: "Sep 28, 2023", excerpt: "Gentle yet effective. Learn how our signature recovery treatment is taking the beauty world by storm." },
    { id: 3, title: "A Guide to Sustainable Beauty", category: "Sustainability", img: "https://beautina-cosmetic.myshopify.com/cdn/shop/files/gallery-image-7.webp?v=1773290459", date: "Sep 15, 2023", excerpt: "How to build an eco-friendly vanity without compromising on luxury or efficacy." },
    { id: 4, title: "Essential Hydration for Every Season", category: "Skincare", img: "https://beautina-cosmetic.myshopify.com/cdn/shop/files/about-img-3.webp?v=1773290459", date: "Aug 02, 2023", excerpt: "Stay protected while glowing. Our top picks for lightweight, non-greasy hydration." },
    { id: 5, title: "Mastering the Night Cleansing Ritual", category: "Rituals", img: "https://beautina-cosmetic.myshopify.com/cdn/shop/files/gallery-image-1.jpg?v=1773290459", date: "Jul 18, 2023", excerpt: "Why washing your face once might not be enough. Mastering the ultimate cleansing ritual." },
    { id: 6, title: "The Science Behind Superseed Oil", category: "Ingredients", img: "https://beautina-cosmetic.myshopify.com/cdn/shop/files/1-superseed-age-recovery-oil-30ml-A2603.jpg?v=1773123649", date: "Jun 05, 2023", excerpt: "Navigate the world of botanical oils to find a treatment that perfectly balances your skin." },
  ];
