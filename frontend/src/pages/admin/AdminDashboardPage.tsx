          ...
          <div className="space-y-4">
            {lowStockProducts.map((product: any) => (
              <div key={product._id} className="flex items-center p-3 border border-red-100 bg-red-50/30 rounded-sm">
                <img src={product.images[0]?.url || '/images/migrated/9_b17_540x_aa6b96c0-cd33-460e-8da7-208e8c30f82e.webp'} alt={product.name} className="w-10 h-12 object-cover mr-3 bg-white" />
