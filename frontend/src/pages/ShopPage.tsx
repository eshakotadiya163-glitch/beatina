...
const ShopPage = () => {
  ...
  const fetchProducts = async ({ pageParam = 1 }) => {
    let url = `/products?pageNumber=${pageParam}&sort=${sort}`;
  ...
  const {
    ...
    queryKey: ['products', sort, categoryFilter, priceFilter],
  ...
  return (
    <div className="pt-[116px] pb-20 bg-white min-h-screen">
      ...
      {/* Page Header matching Beautina */}
      <div className="bg-brand-light py-12 mb-12 text-center border-b border-brand-border">
        <h1 className="font-heading text-4xl text-brand-dark tracking-wide uppercase">Shop All</h1>
