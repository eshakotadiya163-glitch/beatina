      ...
      <section className="max-w-6xl mx-auto px-4 xl:px-0 mb-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="relative aspect-square md:aspect-[4/5] overflow-hidden">
            <img 
              src="https://beautina-cosmetic.myshopify.com/cdn/shop/files/about-img-3.webp?v=1773290459" 
              alt="About Beautina" 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div>
              <div className="w-16 h-16 mx-auto mb-6 flex items-center justify-center border border-white/20 rounded-full">
                <img src="https://beautina-cosmetic.myshopify.com/cdn/shop/files/Icon_2.png?v=1773290459" alt="Organic" className="w-8 h-8 invert brightness-0" />
              </div>
            ...
            <div>
              <div className="w-16 h-16 mx-auto mb-6 flex items-center justify-center border border-white/20 rounded-full">
                <img src="https://beautina-cosmetic.myshopify.com/cdn/shop/files/Icon_4.png?v=1773290459" alt="Cruelty Free" className="w-8 h-8 invert brightness-0" />
              </div>
            ...
            <div>
              <div className="w-16 h-16 mx-auto mb-6 flex items-center justify-center border border-white/20 rounded-full">
                <img src="https://beautina-cosmetic.myshopify.com/cdn/shop/files/Icon_3.png?v=1773290459" alt="Dermatologist Tested" className="w-8 h-8 invert brightness-0" />
              </div>
      ...
      <section className="py-24 max-w-6xl mx-auto px-4 xl:px-0">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 md:order-2 relative aspect-[4/3] overflow-hidden">
            <img 
              src="https://beautina-cosmetic.myshopify.com/cdn/shop/files/gallery-2-v2.webp?v=1773290459" 
