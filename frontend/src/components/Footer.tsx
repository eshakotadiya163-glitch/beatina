...
// Real footer links extracted from Beautina storefront
const footerSections = [
  ...
  },
  {
    title: 'Trending Now',
    links: [
      { label: 'Spot Roll-On', to: '/products/acne-spot-roll-on' },
      { label: 'Scalp Peel Serum', to: '/products/scalp-peel-serum' },
      { label: 'Balancing Fluid', to: '/products/deep-moisture-balancing-fluid' },
      { label: '3 Min Growth Boost', to: '/products/boost-3-min-growth-boost-scalp-treatment' },
      { label: 'Nourishing Cream', to: '/products/deep-moisture-nourish-cream-for-face' },
    ],
  },
];
