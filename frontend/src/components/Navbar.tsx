  ...
  const navLinks = [
    { label: 'Home', href: '/' },
    {
      ...
      mega: {
        ...
        promoImg: 'https://beautina-cosmetic.myshopify.com/cdn/shop/files/s2_1512x_98eb4d02-1fb4-4572-912e-640bff0b5a70.jpg?v=1773124924',
      },
    },
    {
      label: 'Products',
          ...
          <div className="py-4 flex items-center justify-between gap-4 relative">
            ...
            <div className="absolute left-1/2 -translate-x-1/2">
              <Link to="/" className="flex items-center">
                <img 
                  src="https://beautina-cosmetic.myshopify.com/cdn/shop/files/Beautina_1.png?v=1773124992&width=340" 
                  alt="Beautina" 
