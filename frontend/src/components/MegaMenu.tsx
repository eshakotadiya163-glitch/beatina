...
const MegaMenu = () => {
  ...
  const megaMenuContent = {
    makeup: {
      ...
      rightImage: 'https://beautina-cosmetic.myshopify.com/cdn/shop/files/s2_1512x_98eb4d02-1fb4-4572-912e-640bff0b5a70.jpg?v=1773124924',
      rightText: 'New Arrivals in Makeup'
    },
    skin: {
      left: ['Cleansers', 'Moisturizers', 'Serums & Essences', 'Masks', 'Eye Care', 'Sun Care'],
      rightImage: 'https://beautina-cosmetic.myshopify.com/cdn/shop/files/gallery-3-v2.webp?v=1773124923',
                ...
                <div className="absolute top-full left-0 w-full bg-white shadow-lg border-t border-gray-100 p-8 grid grid-cols-4 gap-8 z-50">
                  ...
                  <div className="col-span-2 flex justify-end">
                    <Link to="/shop" className="relative group block w-full max-w-sm overflow-hidden rounded">
                       <img 
                        src={megaMenuContent[category.id as keyof typeof megaMenuContent]?.rightImage || 'https://beautina-cosmetic.myshopify.com/cdn/shop/files/gallery-image-7.webp?v=1773124923'}
                        alt="Promo" 
