...
const TestimonialsCarousel = () => {
  return (
    <div className="bg-white py-[40px] md:py-[50px]">
      <div className="container mx-auto px-4 max-w-[1400px]">
        
        {/* Section Heading */}
        <div className="text-center mb-8 md:mb-10">
          <div className="text-[12px] font-medium tracking-[0.2em] uppercase text-black mb-2">
            user review
          </div>
          <h3 className="text-[28px] md:text-[36px] font-medium tracking-[-0.02em] text-black">
            <span>Real People, Real Results</span>
          </h3>
        </div>

        {/* Carousel Wrapper */}
        <div className="relative px-0 md:px-8 max-w-5xl mx-auto group">
          <Swiper
            ...
            {quotes.map((quote, index) => (
              <SwiperSlide key={index}>
                <div className="flex flex-col-reverse md:flex-row items-center w-full">
                  ...
                  {/* Left: Text Content */}
                  <div className="w-full md:w-1/2 pt-6 pb-12 md:py-12 md:pr-12 px-4 md:px-0 flex flex-col justify-center">
                    <div className="text-[11px] md:text-[12px] font-medium tracking-[0.2em] uppercase text-black pb-3">
                      Comment
                    </div>
                    
                    <div className="pt-3 pb-3 text-black">
                      <StarRating />
                      <div className="text-[16px] md:text-[18px] leading-[1.6] font-normal">
                        {quote.text}
                      </div>
                    </div>
                    
                    <div className="font-heading text-[20px] italic mt-1 text-black">
                      {quote.author}
                    </div>
                  </div>
          ...
          {/* Navigation Arrows */}
          <button className="swiper-button-prev-quote absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 md:-translate-x-8 z-10 w-10 h-10 bg-white rounded-full shadow-[0_4px_12px_rgba(0,0,0,0.15)] hidden md:flex items-center justify-center text-black opacity-0 group-hover:opacity-100 transition-opacity cursor-pointer border-none">
          ...
          <button className="swiper-button-next-quote absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 md:translate-x-8 z-10 w-10 h-10 bg-white rounded-full shadow-[0_4px_12px_rgba(0,0,0,0.15)] hidden md:flex items-center justify-center text-black opacity-0 group-hover:opacity-100 transition-opacity cursor-pointer border-none">
